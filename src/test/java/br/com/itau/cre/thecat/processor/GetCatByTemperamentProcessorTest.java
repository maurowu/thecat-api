...
public class GetCatByTemperamentProcessorTest {
	...
	@InjectMocks
	private GetCatByTemperamentProcessor getCatByTemperamentProcessor = new GetCatByTemperamentProcessor();
	...
	public void processTest() throws Exception {
		...
		Mockito.when(catsBreedsRepository.findByTemperamentContains(Mockito.any())).thenReturn(opt);
		getCatByTemperamentProcessor.process(exchange);
	...
	public void processExceptionTest() throws Exception {
		...
		catsBreeds.add(CatsBreeds.builder().catId("10").build());
		List<CatsBreeds> opt = catsBreeds;
		BDDMockito.given(catsBreedsRepository.findByTemperamentContains(Mockito.any())).willAnswer(invocation -> {
